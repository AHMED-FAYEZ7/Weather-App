...
import 'package:weather_app/weather/data/repository/weather_rapo.dart';
...
void main() async {
  BaseRemoteDateSource baseRemoteDateSource = RemoteDataSource();
  BaseWeatherRepository baseWeatherRepository =
      WeatherRepository(baseRemoteDateSource);
  Weather weather =
